 ...
 * java.sql.SQLException; import java.util.Map;
 * 
 * import com.mysql.jdbc.CallableStatement;
 * 
 * import contract.model.IElement; import factory.ElementFactory; import
 * mobile.Block; import mobile.Diamond;
 * 
 ...
 * currentYToWrite, tempMap)); tempMap.addDiamondCount(); currentXToWrite++; }
 * else { skipNext = false; } if (currentXToWrite % width == 0 &&
 * currentXToWrite != 0) { currentXToWrite = 0; currentYToWrite++; } skipNext =
 * true; } } }
 * 
